...
grep -v "^#" config/hg_filters.csv |
    parallel --skip-first-line --colsep ',' python scripts/assimilate_simulated.py -k data.filter.rf={1} -k data.dynamics.model=models/posp.yml $APARAMS config/song_dynamical.yml results/posp_{1}_xval.npz
