...
python scripts/assimilate.py ${APARAMS} -k data.dynamics.model=models/posp.yml -k data.dynamics.current_scaling=2.0 config/univariate_dynamical.yml results/univariate_posp_samples.npz
