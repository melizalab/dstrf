...
def matbounds(t1, t2, tr):
    ...
    return lambda mparams: (mparams[2] > aa1 * mparams[1]) and (
        mparams[2] > aa2 * mparams[1]
    )
...
def predict_spikes_glm(V, params, cf):
    ...
    omega, a1, a2 = params
    return mat.predict_poisson(
        V - omega, (a1, a2), cf.model.ataus, cf.model.t_refract, cf.model.dt, upsample
    )
