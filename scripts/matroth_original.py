...
p0 = startpos.uniform_independent(nwalkers,[-100,-10,-10],[100,10,10])
...
map_corr = utils.dstrf_sample_validate(model,dmap,test_stims,test_psth,t_dsample,psth_smooth,plt=False,figsize=(4,1))
